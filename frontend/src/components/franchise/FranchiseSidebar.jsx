...
const items = [
  ...
  { to: '/franchise/bookings',  icon: CalendarCheck,   label: 'Bookings' },
  { to: '/franchise/queue',     icon: ListOrdered,     label: 'Vehicle Queue' },
  { to: '/franchise/customers', icon: Users,           label: 'Customers' },
...
export default function FranchiseSidebar() {
  ...
  return (
    <aside style={{
      width: 230, // Increased slightly for better spacing with new icons
      background: '#07081e',
